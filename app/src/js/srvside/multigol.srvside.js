...
var GOLSrv = function GOLSrv() {
    ...
    this.init = function(io, htBuilder) {

        _io = io;
        _htBuilder = htBuilder;
        console.log('____________________________________________________'.white);
        console.log('|_ init server multigol.'.white);
        _hashTable = _htBuilder.build();
        _newBornCellsHashTable = _htBuilder.build();
        _dyingCellsHashTable = _htBuilder.build();
